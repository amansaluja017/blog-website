...
import { getCurrentUser, googleUser, login, logout, updateDetails, updatePassword, userRegister, setPassword, verifyEmail, verifyOtp, checkUser } from '../controller/user.controller';
